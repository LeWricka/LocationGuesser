...
// solo-lectura (reversible). La gestión de GENTE (co-dueños, expulsar, salir,
// transferir) NO vive aquí: tiene su entrada propia "Miembros" en el menú ⋯
// (MembersModal, #616) — un solo sitio canónico, visible a todos los miembros.
