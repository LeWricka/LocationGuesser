...
describe('Landing', () => {
  test('muestra el hero a sangre y el CTA, con el email oculto en el popup', () => {
    render(<Landing />)
    expect(
    ...
    // El email NO está a la vista: vive en el popup, cerrado de inicio.
  ...
  test('con groupName adapta el copy del hero a unirse al viaje', () => {
  ...
  test('el atajo de código de viaje abre su popup y navega a #g=<código>', async () => {
    render(<Landing />)
