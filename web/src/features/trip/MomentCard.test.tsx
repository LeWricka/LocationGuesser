...
// El disco "vínculo con un recuerdo" (issue #822, `associatedWithMemory`) se
// retiró en el #839: un reto asociado ya no llega aquí como tarjeta propia —
// `TripDiario` lo FUSIONA en la tarjeta del recuerdo antes de montar
// `MomentCard` (ver `lib/trip.test.ts` → `fuseMemoryWithChallenge`), así que
// este componente ya no necesita saber de la asociación.
