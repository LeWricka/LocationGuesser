...
const PAPER = '#f6f7f9' // background_color (papel de marca)
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        short_name: 'Lugares',
        description:
          'Comparte tus momentos de una forma diferente: enseña dónde estás y deja que tu gente lo adivine en el mapa.',
        lang: 'es',
        display: 'standalone',
        start_url: '/',
        scope: '/',
